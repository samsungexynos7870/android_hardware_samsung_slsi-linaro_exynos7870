...
#else
#define FNAME	"/data/vendor/gk/gk_context_"
#define FNAME_SUB	"/data/vendor/gk/gk_context_sub_"
#endif
...
#ifdef USE_VENDOR_PARTITION
char secureSecDispTrustedApp[] = "/vendor/app/mcRegistry/08130000000000000000000000000000.tlbin";
#else

...
/* vsync monitor logging spams logcat every 100 frames; off while bring-up */
...
#ifdef CAMERA_GED_FEATURE
/* Disabled for the 34xx stack: the FPS60/120/240 HWDIS buffer formulas
 * (37/96/96) exceed the 3.18 driver's 32-buffer cap -> every high-speed
 * session dies at reqBuffers. CONSTRAINED_HIGH_SPEED_VIDEO was trimmed in
 * ExynosCameraAvailabilityTable.h accordingly. */
...
#define USE_DYNAMIC_BAYER_120FPS_VIDEO_SNAP_SHOT (false)

#define USE_DYNAMIC_BAYER_120FPS_VIDEO_SNAP_SHOT_FRONT  (false)
#define USE_DYNAMIC_BAYER_240FPS_VIDEO_SNAP_SHOT_FRONT  (false)

#define USE_DYNAMIC_BAYER_240FPS_VIDEO_SNAP_SHOT       (false)
...
#define FPS240_NUM_REPROCESSING_BUFFERS      (NUM_REPROCESSING_BUFFERS)
#define FPS240_NUM_FASTAESTABLE_BUFFERS      (NUM_FASTAESTABLE_BUFFERS)
#define FPS240_REPROCESSING_BAYER_HOLD_COUNT (REPROCESSING_BAYER_HOLD_COUNT)

#define FPS240_INIT_BAYER_BUFFERS            (INIT_BAYER_BUFFERS * 4)
...
#define FPS240_NUM_REQUEST_BLOCK_MAX         (FPS240_NUM_PREVIEW_BUFFERS)
#define FPS240_NUM_REQUEST_BLOCK_MIN         (FPS240_INIT_BAYER_BUFFERS + 16)
...
/* Unsupported 7870 D1 nodes: positive sentinels avoid unsigned case-label narrowing. */
